...
def fetch(*args, **kwargs):
    """Execute a query and return all rows; retry on transient interface errors."""
    ...
    with get_connection() as conn:
        with conn.cursor() as cur:
            try:
                ...
                # Handle NULL returned by MAX() on an empty table by
                # treating it as 0 so subsequent comparisons work.
                latest_migration = cur.fetchone()[0] or 0
